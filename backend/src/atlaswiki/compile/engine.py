...
from atlaswiki.compile.prompts import build_compile_messages, build_segment_messages
from atlaswiki.config import ConfigStore
from atlaswiki.errors import AppError, ErrorCode
from atlaswiki.jobs import Job, JobQueue, job_queue
from atlaswiki.llm import complete as default_llm_complete
from atlaswiki.llm.cost import read_job_cost
from atlaswiki.schema import MaterialStatus, PageType, normalize_page_name
from atlaswiki.workspace.links import extract_links
from atlaswiki.workspace.store import RESERVED_PAGE_NAMES, PageDraft, atomic_write_bytes, utc_now
...
class CompileEngine:
    ...
    def config_store(self) -> ConfigStore:
        ...
        from atlaswiki.config import config_store as default_config_store
