...
from atlaswiki.ingest.note import import_note as ingest_note
from atlaswiki.ingest.pdf import import_pdf as ingest_pdf
from atlaswiki.ingest.service import source_service
from atlaswiki.ingest.web import fetch_web as ingest_web
...
async def import_pdf(
    ...
    with tempfile.NamedTemporaryFile(prefix="atlaswiki-upload-", suffix=suffix, delete=False) as handle:
        size = 0
